   ...
   client.on("message", message => {
    if (message.content === "-help-1") {
     const embed = new Discord.RichEmbed() 
         ...
         :hearts: الموقع الرسمي للبوتXNXX.com website here  :hearts: **`)
   ...
   client.on("message", message => {
    if (message.content === "-help-a") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  https://discord.gg/TZ3dcyC :scroll:
         :hearts: الموقع الرسمي للبوت XNXX website here  :hearts: **`)
   message.author.sendEmbed(embed)
...
**  ======:blossom:نــتــمــنــآ لــكــم آســتــمـــتــآع :blossom:======  **`)
     message.author.sendEmbed(embed)
      ...
      if (message.content === "-help-a") {
       const embed = new Discord.RichEmbed() 
           .setColor("#FF00FF")
           .setFooter('By *̲X̲B̲O̲O̲M̲X̲#3600  ')
...
if (message.author.id !== '403641716797603853') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
const sWlc = {}
const premium = ['403641716797603853', '', '', '']
client.on('message', message => {
var prefix = "-";
...
حآول العبث بالسيرفر ${channel.guild.name}`)
 ...
 channelr[channelremover.id].deleted = 0;
  ...
  client.on('message', message => { 
    ...
    .setFooter(`ARMY SYSTEAM`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
